...
const ITEMS: DockItem[] = [
  { key: "about", label: "About", icon: Brain },
  { key: "art", label: "Art", icon: Images },
  { key: "philosophy", label: "Philosophy", icon: User },
  { key: "resume", label: "Matriz", icon: FileText },
]
...
export default function Dock({
  ...
  return (
    <div className="flex items-center gap-3 border-[3px] border-black px-3 py-3 rounded-xl shadow-[6px_6px_0_0_#000]" style={{
        ...
        return (
          <button
            ...
            className={cn(
              ...
              isActive ? "shadow-[6px_6px_0_0_#000] bg-white" : "shadow-[4px_4px_0_0_#000] bg-[#FAFAF0]",
            )}
      ...
      <div className="mx-1 w-[2px] self-stretch bg-white/20" />
      <button
